CREATE VIEW [dbo].[dfpc_online_consultation_view]
AS

SELECT A.[Unique ID] AS [dfpc_online_consultation_Unique ID]
      ...
      ,C.[Online consultation system supplier] AS [M62_Online consultation system supplier]
